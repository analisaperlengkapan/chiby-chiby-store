...
constructor(
    ...
    override suspend fun exportGrossSalesReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportProfitMarginReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportNetProfitReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportSalesByProductReport(
            startDate: LocalDate,
            endDate: LocalDate
    ...
    override suspend fun exportSalesByCategoryReport(
            startDate: LocalDate,
            endDate: LocalDate
    ): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportSalesTrendReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportIncomeStatement(date: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportCashFlowReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportExpenseReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportBalanceSheet(asOfDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    override suspend fun exportPeriodicSummaryReport(startDate: LocalDate, endDate: LocalDate): Result<String> = withContext(ioDispatcher) {
        try {
    ...
    private fun createExpenseReportPdf(
        ...
        try {
            ...
            data.pengeluaranPerKategori.forEach { (category, amount) ->
    ...
    private fun addHeader(
        ...
        val dateText =
                when {
                    ...
                    date != null -> "Per tanggal: ${date.format(dateFormatter)}"
                    else -> ""
                }
