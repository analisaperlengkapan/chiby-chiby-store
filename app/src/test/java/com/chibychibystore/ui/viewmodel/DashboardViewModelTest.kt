...
class DashboardViewModelTest {
    ...
    fun initialLoadSuccess() = runTest {
        ...
        val pr: com.chibychibystore.repository.ProdukRepository = mock()
        ...
        whenever(pr.getLowStockProduk()).thenReturn(flowOf(emptyList()))
        val vm = DashboardViewModel(ss, rs, pr)
        advanceUntilIdle()
