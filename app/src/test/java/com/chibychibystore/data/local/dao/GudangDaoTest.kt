...
class GudangDaoTest {
    ...
    @Test
    fun insertAndGetGudang() = runBlocking {
        val id = dao.insertGudang(Gudang(name = "Gudang A"))
        val fetched = dao.getGudangById(id)
        Assert.assertNotNull(fetched)
        Assert.assertEquals("Gudang A", fetched?.name)
    }
}
