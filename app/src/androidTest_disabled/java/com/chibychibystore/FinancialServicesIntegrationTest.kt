...
class FinancialServicesIntegrationTest {
    ...
    fun testBalanceSheetServiceIntegration() = runBlocking {
        ...
        val equity = balanceSheet_service.calculateEquity(asOfDate)
    ...
    fun testReportingServiceFinancialIntegration() = runBlocking {
        ...
        val cashFlow = reporting_service.getCashFlow(startDate, endDate)
    ...
    fun testExpenseApprovalWorkflow() = runBlocking {
        ...
        val expenseId = requireNotNull(result.getOrNull())
